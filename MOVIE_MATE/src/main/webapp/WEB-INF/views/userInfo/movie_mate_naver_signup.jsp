	...
	<form>
		<div id="kakao_main_box">
			...
			<div class="input_box input-group mb-2" id="email_box">
				<input type="text" name="email" class="kakao_form-control"
					id="email" onkeyup="validation('email');" value="${email}" />
			</div>
			...
			<input type="button" value="회원가입"
				class="btn kakao_btn-outline-danger" id="kakao_signUp_btn"
				onclick="signUp(this.form);" />
