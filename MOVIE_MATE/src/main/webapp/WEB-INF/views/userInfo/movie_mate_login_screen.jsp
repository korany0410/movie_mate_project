...
<mapper namespace="mmcomment">
   <select id="selectList" resultType="vo.CommentList_ViewVO"
      ...
      from (select * from moviemate_user mmu,
      moviemate_comment mc,
      movie_user mu
      where mmu.username = mc.com_username
      ...
      mmu.user_idx =
      mu.user_idx
      AND mc.m_ref = mu.movie_idx AND(1=2 OR star_score > 0 Or
      want_view =
   ...
   <select id="commentOrigin" resultType="vo.CommentList_ViewVO"
      ...
      SELECT mmm.profile_img movie_profile_img,
