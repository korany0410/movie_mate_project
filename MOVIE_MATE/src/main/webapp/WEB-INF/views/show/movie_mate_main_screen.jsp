...
<body>
	...
	<h3>Movie Mate 명작 영화</h3>
	<div id="carouselExample" class="carousel slide">
		<div class="carousel-inner">
			<div class="carousel-item active">
				<c:forEach var="i" begin="0" end="4">
					<div class="movie1">
						<img class="img1" alt="" src="${masterpiece_list[i].profile_img}">
						<div class="fw-bold">${masterpiece_list[i].title }</div>
						<div>${masterpiece_list[i].nation }</div>
						<div>${masterpiece_list[i].genre }</div>
